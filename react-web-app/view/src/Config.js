...
const status = 'prod'
export const API_URL = status === 'prod' ? 'http://dma.com.bd:8007/' : 'http://localhost:8000/'
export const API_URL_8008 = status === 'prod' ? 'http://dma.com.bd:8008/' : 'http://localhost:8000/'
...
export const API_8008 = axios.create({
  baseURL: API_URL_8008,
  timeout: 100000,
  headers: {
    "Authorization": `Bearer ${sessionStorage.getItem(TOKEN)}`,
    "Content-Type": "application/json",
...
API_8008.interceptors.request.use(
  function(config) {
